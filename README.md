...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/net-http2-secure-server/tags). For example,

```javascript
http2ServerFactory = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/net-http2-secure-server@v0.1.1-umd/browser.js' )
```
